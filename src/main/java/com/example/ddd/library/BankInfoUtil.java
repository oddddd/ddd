...
public class BankInfoUtil {
    ...
    public static void main(String args[]) {
        BankInfoUtil bankInfoUtil = new BankInfoUtil("6225365271562822");
        System.out.println(bankInfoUtil.getBankName() + "--" + bankInfoUtil.getCardType() + "--" + bankInfoUtil.getReg() + "--" + bankInfoUtil.getBankId());
    }
